...
public class Options extends JFrame implements ActionListener
{
    ...
    private void initComponents() {
        ...
        namePlayerOne.setFont(new java.awt.Font("DejaVu Sans", 0, 14));
        namePlayerOne.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        namePlayerOne.setText("Player 1");

        namePlayerTwo.setFont(new java.awt.Font("DejaVu Sans", 0, 14));
        ...
        nameComputer.setFont(new java.awt.Font("DejaVu Sans", 0, 14));
    ...
    {
        if(false == isFirstAlwaysMovePlayerOne.isSelected())
        {
            isFirstAlwaysMovePlayerOne.setSelected(false);
        }
        else
        {
            isFirstAlwaysMovePlayerOne.setSelected(true);
        }
    ...
    {
        if(false == isFirstAlwaysMovePlayerTwo.isSelected())
        {
            isFirstAlwaysMovePlayerTwo.setSelected(false);
        }
        else
        {
            isFirstAlwaysMovePlayerTwo.setSelected(true);
        }
        isFirstAlwaysMovePlayerOne.setSelected(false);
    }
    ...
    {
        return (isSecondPlayerHuman.isSelected()) ? false : true;
    }

    public boolean isFirstMoveAlwaysPlayerOne()
    {
        return (isFirstAlwaysMovePlayerOne.isSelected()) ? true : false;
    }

    public boolean isFirstMoveAlwaysPlayerTwo()
    {
        return (isFirstAlwaysMovePlayerTwo.isSelected()) ? true : false;
    }
